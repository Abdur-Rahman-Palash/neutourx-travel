    ...
    <div className={cn("flex-1 bg-background text-foreground", className)}>
      ...
      <section className="relative min-h-[80vh] bg-white overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          {/* Floating Particles */}
          <div className="absolute top-20 left-10 w-72 h-72 bg-accent-cyan/20 rounded-full blur-3xl animate-pulse" />
          <div className="absolute top-40 right-20 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl animate-pulse delay-1000" />
          <div className="absolute bottom-20 left-1/3 w-80 h-80 bg-purple-500/10 rounded-full blur-3xl animate-pulse delay-2000" />
          
          {/* Animated Lines */}
          <div className="absolute inset-0">
            <div className="absolute top-1/4 left-0 right-0 h-px bg-gradient-to-r from-transparent via-accent-cyan/50 to-transparent animate-pulse" />
            <div className="absolute top-1/2 left-0 right-0 h-px bg-gradient-to-r from-transparent via-blue-500/30 to-transparent animate-pulse delay-500" />
            <div className="absolute top-3/4 left-0 right-0 h-px bg-gradient-to-r from-transparent via-purple-500/20 to-transparent animate-pulse delay-1000" />
          </div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          >
            {/* Main Title */}
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-16 mt-0 leading-[1.1]">
              <span className="bg-gradient-to-r from-gray-900 via-accent-cyan to-accent-gold bg-clip-text text-transparent">
