...
export default function TravelPackages() {
  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 via-white to-slate-100">
      <div className="max-w-7xl mx-auto">
        <div ref={sectionRef} className="text-center mb-16">
          <h2 ref={titleRef} className="text-4xl md:text-5xl font-semibold tracking-tight text-slate-900 mb-4">
          ...
          {packages.map((pkg, index) => {
            ...
            return (
              <motion.article
                ...
                className="group relative overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-[0_30px_80px_rgba(15,23,42,0.08)] transition-shadow hover:shadow-[0_30px_90px_rgba(15,23,42,0.18)]"
              ...
              >
                ...
                <div className="relative p-8 sm:p-10">
                  <div className="flex h-16 w-16 items-center justify-center rounded-3xl bg-slate-900 text-white shadow-lg shadow-slate-900/10 mb-6">
                    <Icon className="h-8 w-8" />
                  </div>
                  <h3 id={`package-title-${index}`} className="text-2xl font-semibold text-slate-900 mb-2">
                    {pkg.title}
                  </h3>
                  <p className="text-sm uppercase tracking-[0.24em] text-slate-500 mb-6">
                    {pkg.subtitle}
                  </p>

                  <div className="mb-6">
                    <div className="flex flex-col gap-3 text-slate-900 mb-4 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <button
                    type="button"
                    className="inline-flex w-full items-center justify-center rounded-full bg-slate-900 px-6 py-3 text-sm font-semibold text-white transition hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
